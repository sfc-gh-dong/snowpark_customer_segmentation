...
st.write(":red[Cluster 2] are your Loyalists. They generally spend more money and more frequently.")
st.write(":blue[Cluster 1] spend less money and less frequently, but they spent in the last 5 months.")
st.write(":orange[Cluster 3] spend less money and less frequently, but they spent beyond the last 5 months.")
